...
export default function PostPage({post}){
    return (
        ...
        <meta property="og:image" content={post['_embedded']['wp:featuredmedia'][0].media_details.sizes.large['source_url'] || data[0]['_embedded']['wp:featuredmedia'][0].media_details.sizes.medium['source_url']} />
        ...
        <meta property="twitter:image" content={post['_embedded']['wp:featuredmedia'][0].media_details.sizes.large['source_url'] || data[0]['_embedded']['wp:featuredmedia'][0].media_details.sizes.medium['source_url']} />
      </Head>
        ...
        <div className="container pt-5 pb-5">
            ...
            <img className="img-fluid rounded" alt={post.title.rendered} src={post['_embedded']['wp:featuredmedia'][0].media_details.sizes.large['source_url'] || data[0]['_embedded']['wp:featuredmedia'][0].media_details.sizes.medium['source_url']} />
