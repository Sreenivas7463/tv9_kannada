...
function Page({ data }) {
    ...
    return (
        ...
        <meta property="og:image" content={data[0]['_embedded']['wp:featuredmedia'][0].media_details.sizes.large['source_url'] || data[0]['_embedded']['wp:featuredmedia'][0].media_details.sizes.medium['source_url']} />
        ...
        <meta property="twitter:image" content={data[0]['_embedded']['wp:featuredmedia'][0].media_details.sizes.large['source_url'] || data[0]['_embedded']['wp:featuredmedia'][0].media_details.sizes.medium['source_url']} />
        ...
        <h1 className="text-center pb-5 text-secondary" dangerouslySetInnerHTML={{__html: data[0].title.rendered}}></h1>
         ...
         src={data[0]['_embedded']['wp:featuredmedia'][0].media_details.sizes.large['source_url'] || data[0]['_embedded']['wp:featuredmedia'][0].media_details.sizes.medium['source_url']}
